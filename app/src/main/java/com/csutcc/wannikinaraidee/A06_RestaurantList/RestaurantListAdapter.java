package com.csutcc.wannikinaraidee.A06_RestaurantList;
...
public class RestaurantListAdapter extends BaseAdapter {
    ...
    public RestaurantListAdapter(Context context, String[] name,String[] message,int[] image) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.a06_restaurant_item_list, parent, false);
